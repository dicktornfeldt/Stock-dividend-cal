    ...
    <ModalContainer>
      ...
      <div>
        ...
        <p>
          ...
          webbläsare som kan se din portfölj. Vill du se portföljen i både din dator, andra datorer
          och telefoner så måste du skapa den i respektive enhet.
        </p>
        <p>
          <strong>
        ...
        <p>
          ...
          </strong>Webappen använder sig av Google Analytics för att spåra trafik. Däremot så sparas
          inte data som har med enskild användare att göra, dvs. webappen sparar inte ditt
          IP-nummer, i enlighet med GDPR.
        </p>
        <p>
          <strong>
            Varför funkar inte ...XXX?<br />
          </strong>Detta är en webbapp som jag byggt främst för att göra mitt eget aktieinvesterande
          ännu lite roligare. Jag är dessutom utvecklare, så jag kombinerar lite allmän nytta med
          egen vinning. Med det sagt så tar jag mer än gärna emot konstruktiv kritik, må det vara
